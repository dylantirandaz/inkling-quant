...
MEASUREMENT_DEPLOY_CHALLENGE_MAX_AGE_SECONDS: Final = 2 * 60 * 60
MEASUREMENT_LAUNCH_CHALLENGE_MAX_AGE_SECONDS: Final = 2 * 60 * 60
    ...
    def exact_post_patch_runtime(self) -> MeasurementRuntimeIdentity:
        expected_patches = (
            ...
            (
                ...
                "3de1b72d8dc67350f2aaacc58cef62a49eeba38fce3f20cb8d8c7740548843bf",
                8644,
            ),
        )
